...
// replace github.com/xornet-sl/go-xrpc => ../../../my/go-xrpc/go-xrpc

require (
	github.com/gin-gonic/gin v1.10.1
	github.com/pikvm/cloud-api v0.0.11
	...
	github.com/xornet-sl/go-xrpc v0.0.10
	github.com/xornet-sl/xcommon v0.0.1
